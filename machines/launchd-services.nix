    ...
    aerospace-ghost-cleanup =
      ...
      in
      {
        ...
        config = {
          ...
          StandardOutPath = "${config.home.homeDirectory}/Library/Logs/aerospace-ghost-cleanup.log";
          StandardErrorPath = "${config.home.homeDirectory}/Library/Logs/aerospace-ghost-cleanup.log";
        };
      };
